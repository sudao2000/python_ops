...
class TestOpsAuto(unittest.TestCase):
    ...
    def test_auto_024_tensor_view(self):
        func_name = 'Tensor.view'
    ...
    # Source: ops.log line 58
    def test_auto_025_tensor_reshape(self):
    ...
    def test_auto_028_tensor_getitem(self):
    ...
    def test_auto_029_tensor_reshape(self):
        func_name = 'Tensor.reshape'
    ...
    def test_auto_030_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.bfloat16', 'shape': [5120], 'stride': [13824]}, 'key': {'data_type': 'ellipsis', 'value': 'Ellipsis'}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    # Source: ops.log line 74
    def test_auto_033_tensor_view(self):
        func_name = 'Tensor.view'
    ...
    # Source: ops.log line 75
    def test_auto_034_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
    ...
    def test_auto_036_tensor_view(self):
        func_name = 'Tensor.view'
    ...
    def test_auto_039_tensor_reshape(self):
        func_name = 'Tensor.reshape'
    ...
    # Source: ops.log line 86
    def test_auto_041_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
    ...
    # Source: ops.log line 87
    def test_auto_042_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.bfloat16', 'shape': [1024], 'stride': [5120]}, 'key': {'data_type': 'ellipsis', 'value': 'Ellipsis'}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_055_tensor_cumsum(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.int64', 'shape': [1, mm], 'stride': [mm, 1]}, 'arg1': {'data_type': 'int', 'value': -1}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_057_tensor_eq(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.int64', 'shape': [1, mm], 'stride': [mm, 1]}, 'arg1': {'data_type': 'int', 'value': 0}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_058_tensor_masked_fill(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.int64', 'shape': [1, mm], 'stride': [mm, 1]}, 'arg1': {'data_type': 'torch.bool', 'shape': [1, mm], 'stride': [mm, 1]}, 'arg2': {'data_type': 'int', 'value': 0}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_060_torch_ones(self):
        func_name = 'torch.ones'
        args_info = {'arg0': {'data_type': 'int', 'value': mm}, 'dtype': {'data_type': 'dtype', 'value': 'torch.int64'}, 'device': {'data_type': 'device', 'value': "device(type='cuda', index=0)"}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_061_tensor_cumsum(self):
        func_name = 'Tensor.cumsum'
        args_info = {'arg0': {'data_type': 'torch.int64', 'shape': [mm], 'stride': [1]}, 'arg1': {'data_type': 'int', 'value': 0}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_062_tensor_sub(self):
        func_name = 'Tensor.__sub__'
        args_info = {'arg0': {'data_type': 'torch.int64', 'shape': [mm], 'stride': [1]}, 'arg1': {'data_type': 'int', 'value': 1}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_063_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.int64', 'shape': [1, mm], 'stride': [mm, 1]}, 'key': {'data_type': 'tuple', 'value': ['slice(None, None, None)', 'slice(-5, None, None)']}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_064_tensor_clone(self):
        func_name = 'Tensor.clone'
        args_info = {'arg0': {'data_type': 'torch.int64', 'shape': [1, mm], 'stride': [mm, 1]}, 'memory_format': {'data_type': 'memory_format', 'value': 'torch.contiguous_format'}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_066_torch_embedding(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [152064, 5120], 'stride': [5120, 1]}, 'arg1': {'data_type': 'torch.int64', 'shape': [1, mm], 'stride': [mm, 1]}, 'arg2': {'data_type': 'int', 'value': -1}, 'arg3': {'data_type': 'bool', 'value': False}, 'arg4': {'data_type': 'bool', 'value': False}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_067_tensor_all(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.bool', 'shape': [1, mm], 'stride': [mm, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_070_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.int64', 'shape': [1, mm], 'stride': [mm, 1]}, 'key': {'data_type': 'tuple', 'value': ['slice(None, None, None)', None, 'slice(None, None, None)']}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_071_tensor_matmul(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, 64, 1], 'stride': [64, 1, 1]}, 'arg1': {'data_type': 'torch.float32', 'shape': [1, 1, mm], 'stride': [mm, mm, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_072_tensor_transpose(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, 64, mm], 'stride': [mm * 64, mm, 1]}, 'arg1': {'data_type': 'int', 'value': 1}, 'arg2': {'data_type': 'int', 'value': 2}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_073_torch_cat(self):
        func_name = 'torch.cat'
        args_info = {'arg0': {'data_type': 'tuple', 'value': [{'data_type': 'torch.float32', 'shape': [1, mm, 64], 'stride': [mm * 64, 1, mm]}, {'data_type': 'torch.float32', 'shape': [1, mm, 64], 'stride': [mm * 64, 1, mm]}]}, 'dim': {'data_type': 'int', 'value': -1}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_074_tensor_cos(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, mm, 128], 'stride': [mm * 128, 128, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_075_tensor_mul(self):
        func_name = 'Tensor.__mul__'
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, mm, 128], 'stride': [mm * 128, 128, 1]}, 'arg1': {'data_type': 'float', 'value': 1.0}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_077_tensor_pow(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, mm, 5120], 'stride': [mm * 5120, 5120, 1]}, 'arg1': {'data_type': 'int', 'value': 2}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_078_tensor_mean(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, mm, 5120], 'stride': [mm * 5120, 5120, 1]}, 'arg1': {'data_type': 'int', 'value': -1}, 'keepdim': {'data_type': 'bool', 'value': True}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_079_tensor_add(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, mm, 1], 'stride': [mm, 1, 1]}, 'arg1': {'data_type': 'float', 'value': 1e-06}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_080_torch_rsqrt(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, mm, 1], 'stride': [mm, 1, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_081_tensor_mul(self):
        func_name = 'Tensor.__mul__'
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, mm, 5120], 'stride': [mm * 5120, 5120, 1]}, 'arg1': {'data_type': 'torch.float32', 'shape': [1, mm, 1], 'stride': [mm, 1, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_082_tensor_mul(self):
        func_name = 'Tensor.__mul__'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [5120], 'stride': [1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 5120], 'stride': [mm * 5120, 5120, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_083_torch_nn_functional_linear(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 5120], 'stride': [mm * 5120, 5120, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [5120, 5120], 'stride': [5120, 1]}, 'arg2': {'data_type': 'torch.bfloat16', 'shape': [5120], 'stride': [1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_084_tensor_view(self):
        func_name = 'Tensor.view'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 5120], 'stride': [mm * 5120, 5120, 1]}, 'arg1': {'data_type': 'tuple', 'value': [1, mm, -1, 128]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_085_tensor_transpose(self):
        func_name = 'Tensor.transpose'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 40, 128], 'stride': [mm * 5120, 5120, 128, 1]}, 'arg1': {'data_type': 'int', 'value': 1}, 'arg2': {'data_type': 'int', 'value': 2}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_086_torch_nn_functional_linear(self):
        func_name = 'torch.nn.functional.linear'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 5120], 'stride': [mm * 5120, 5120, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [1024, 5120], 'stride': [5120, 1]}, 'arg2': {'data_type': 'torch.bfloat16', 'shape': [1024], 'stride': [1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_087_tensor_view(self):
        func_name = 'Tensor.view'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 1024], 'stride': [mm * 1024, 1024, 1]}, 'arg1': {'data_type': 'tuple', 'value': [1, mm, -1, 128]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_088_tensor_transpose(self):
        func_name = 'Tensor.transpose'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 8, 128], 'stride': [mm * 1024, 1024, 128, 1]}, 'arg1': {'data_type': 'int', 'value': 1}, 'arg2': {'data_type': 'int', 'value': 2}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_089_tensor_unsqueeze(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 128], 'stride': [mm * 128, 128, 1]}, 'arg1': {'data_type': 'int', 'value': 1}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_090_tensor_mul(self):
        func_name = 'Tensor.__mul__'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, 40, mm, 128], 'stride': [mm * 5120, 128, 5120, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [1, 1, mm, 128], 'stride': [mm * 128, mm * 128, 128, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_091_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.bfloat16', 'shape': [1, 40, mm, 128], 'stride': [mm * 5120, 128, 5120, 1]}, 'key': {'data_type': 'tuple', 'value': ['Ellipsis', 'slice(None, 64, None)']}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_092_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.bfloat16', 'shape': [1, 40, mm, 128], 'stride': [mm * 5120, 128, 5120, 1]}, 'key': {'data_type': 'tuple', 'value': ['Ellipsis', 'slice(64, None, None)']}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_093_tensor_neg(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, 40, mm, 64], 'stride': [mm * 2560, 64, 2560, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_094_torch_cat(self):
        func_name = 'torch.cat'
        args_info = {'arg0': {'data_type': 'tuple', 'value': [{'data_type': 'torch.bfloat16', 'shape': [1, 40, mm, 64], 'stride': [mm * 2560, 64, 2560, 1]}, {'data_type': 'torch.bfloat16', 'shape': [1, 40, mm, 64], 'stride': [mm * 2560, 64, 2560, 1]}]}, 'dim': {'data_type': 'int', 'value': -1}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_095_tensor_mul(self):
        func_name = 'Tensor.__mul__'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, 40, mm, 128], 'stride': [mm * 5120, mm * 128, 128, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [1, 1, mm, 128], 'stride': [mm * 128, mm * 128, 128, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_096_tensor_add(self):
        func_name = 'Tensor.__add__'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, 40, mm, 128], 'stride': [mm * 5120, 128, 5120, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [1, 40, mm, 128], 'stride': [mm * 5120, mm * 128, 128, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_097_tensor_mul(self):
        func_name = 'Tensor.__mul__'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, 8, mm, 128], 'stride': [mm * 1024, 128, 1024, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [1, 1, mm, 128], 'stride': [mm * 128, mm * 128, 128, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_098_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.bfloat16', 'shape': [1, 8, mm, 128], 'stride': [mm * 1024, 128, 1024, 1]}, 'key': {'data_type': 'tuple', 'value': ['Ellipsis', 'slice(None, 64, None)']}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_099_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.bfloat16', 'shape': [1, 8, mm, 128], 'stride': [mm * 1024, 128, 1024, 1]}, 'key': {'data_type': 'tuple', 'value': ['Ellipsis', 'slice(64, None, None)']}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_100_tensor_neg(self):
        func_name = 'Tensor.__neg__'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, 8, mm, 64], 'stride': [mm * 512, 64, 512, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_101_torch_cat(self):
        func_name = 'torch.cat'
        args_info = {'arg0': {'data_type': 'tuple', 'value': [{'data_type': 'torch.bfloat16', 'shape': [1, 8, mm, 64], 'stride': [mm * 512, 64, 512, 1]}, {'data_type': 'torch.bfloat16', 'shape': [1, 8, mm, 64], 'stride': [mm * 512, 64, 512, 1]}]}, 'dim': {'data_type': 'int', 'value': -1}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_102_tensor_mul(self):
        func_name = 'Tensor.__mul__'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, 8, mm, 128], 'stride': [mm * 1024, mm * 128, 128, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [1, 1, mm, 128], 'stride': [mm * 128, mm * 128, 128, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_103_tensor_add(self):
        func_name = 'Tensor.__add__'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, 8, mm, 128], 'stride': [mm * 1024, 128, 1024, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [1, 8, mm, 128], 'stride': [mm * 1024, mm * 128, 128, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_104_torch_cat(self):
        func_name = 'torch.cat'
        args_info = {'arg0': {'data_type': 'list', 'value': [{'data_type': 'torch.bfloat16', 'shape': [0], 'stride': [1]}, {'data_type': 'torch.bfloat16', 'shape': [1, 8, mm, 128], 'stride': [mm * 1024, 128, 1024, 1]}]}, 'dim': {'data_type': 'int', 'value': -2}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_105_torch_nn_functional_scaled_dot_product_attention(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, 40, mm, 128], 'stride': [mm * 5120, 128, 5120, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [1, 8, mm, 128], 'stride': [mm * 1024, mm * 128, 128, 1]}, 'arg2': {'data_type': 'torch.bfloat16', 'shape': [1, 8, mm, 128], 'stride': [mm * 1024, mm * 128, 128, 1]}, 'attn_mask': {'data_type': 'NoneType', 'value': None}, 'dropout_p': {'data_type': 'float', 'value': 0.0}, 'scale': {'data_type': 'float', 'value': 0.08838834764831845}, 'is_causal': {'data_type': 'bool', 'value': True}, 'enable_gqa': {'data_type': 'bool', 'value': True}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_106_tensor_transpose(self):
        func_name = 'Tensor.transpose'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, 40, mm, 128], 'stride': [mm * 5120, mm * 128, 128, 1]}, 'arg1': {'data_type': 'int', 'value': 1}, 'arg2': {'data_type': 'int', 'value': 2}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_107_tensor_contiguous(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 40, 128], 'stride': [mm * 5120, 128, mm * 128, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_108_tensor_reshape(self):
        func_name = 'Tensor.reshape'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 40, 128], 'stride': [mm * 5120, 5120, 128, 1]}, 'arg1': {'data_type': 'int', 'value': 1}, 'arg2': {'data_type': 'int', 'value': mm}, 'arg3': {'data_type': 'int', 'value': -1}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_109_tensor_contiguous(self):
        func_name = 'Tensor.contiguous'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 5120], 'stride': [mm * 5120, 5120, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_110_torch_nn_functional_linear(self):
        func_name = 'torch.nn.functional.linear'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 5120], 'stride': [mm * 5120, 5120, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [5120, 5120], 'stride': [5120, 1]}, 'arg2': {'data_type': 'NoneType', 'value': None}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_111_tensor_add(self):
        func_name = 'Tensor.__add__'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 5120], 'stride': [mm * 5120, 5120, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 5120], 'stride': [mm * 5120, 5120, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_112_torch_nn_functional_linear(self):
        func_name = 'torch.nn.functional.linear'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 5120], 'stride': [mm * 5120, 5120, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [13824, 5120], 'stride': [5120, 1]}, 'arg2': {'data_type': 'NoneType', 'value': None}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_113_torch_nn_functional_silu(self):
        ...
        args_info = {'input': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 13824], 'stride': [mm * 13824, 13824, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_114_tensor_mul(self):
        func_name = 'Tensor.__mul__'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 13824], 'stride': [mm * 13824, 13824, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 13824], 'stride': [mm * 13824, 13824, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_115_torch_nn_functional_linear(self):
        func_name = 'torch.nn.functional.linear'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 13824], 'stride': [mm * 13824, 13824, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [5120, 13824], 'stride': [13824, 1]}, 'arg2': {'data_type': 'NoneType', 'value': None}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_116_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.bfloat16', 'shape': [1, mm, 5120], 'stride': [mm * 5120, 5120, 1]}, 'key': {'data_type': 'tuple', 'value': ['slice(None, None, None)', 'slice(-1, None, None)', 'slice(None, None, None)']}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_117_torch_nn_functional_linear(self):
        func_name = 'torch.nn.functional.linear'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, 1, 5120], 'stride': [mm * 5120, 5120, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [152064, 5120], 'stride': [5120, 1]}, 'arg2': {'data_type': 'NoneType', 'value': None}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_120_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.int64', 'shape': [1, mm], 'stride': [mm, 1]}, 'key': {'data_type': 'tuple', 'value': ['Ellipsis', 'slice(-1, None, None)']}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_121_tensor_add(self):
        func_name = 'Tensor.__add__'
        args_info = {'arg0': {'data_type': 'torch.int64', 'shape': [1, 1], 'stride': [1, 1]}, 'arg1': {'data_type': 'torch.int64', 'shape': [1, 1], 'stride': [mm, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_123_torch_cat(self):
        func_name = 'torch.cat'
        args_info = {'arg0': {'data_type': 'list', 'value': [{'data_type': 'torch.int64', 'shape': [1, mm], 'stride': [mm, 1]}, {'data_type': 'torch.int64', 'shape': [1, 1], 'stride': [1, 1]}]}, 'dim': {'data_type': 'int', 'value': -1}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_124_tensor_new_ones(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.int64', 'shape': [1, mm], 'stride': [mm, 1]}, 'arg1': {'data_type': 'tuple', 'value': [1, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_125_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.int64', 'shape': [mm], 'stride': [1]}, 'key': {'data_type': 'int', 'value': -1}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_128_torch_cat(self):
        func_name = 'torch.cat'
        args_info = {'arg0': {'data_type': 'tuple', 'value': [{'data_type': 'torch.int64', 'shape': [mm], 'stride': [1]}, {'data_type': 'torch.int64', 'shape': [1], 'stride': [1]}]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_130_torch_gather(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, 152064], 'stride': [152064, 1]}, 'arg1': {'data_type': 'int', 'value': 1}, 'arg2': {'data_type': 'torch.int64', 'shape': [1, mm], 'stride': [mm, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_131_tensor_lt(self):
        func_name = 'Tensor.__lt__'
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, mm], 'stride': [mm, 1]}, 'arg1': {'data_type': 'int', 'value': 0}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_132_tensor_mul(self):
        func_name = 'Tensor.__mul__'
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, mm], 'stride': [mm, 1]}, 'arg1': {'data_type': 'float', 'value': 1.05}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_134_torch_where(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.bool', 'shape': [1, mm], 'stride': [mm, 1]}, 'arg1': {'data_type': 'torch.float32', 'shape': [1, mm], 'stride': [mm, 1]}, 'arg2': {'data_type': 'torch.float32', 'shape': [1, mm], 'stride': [mm, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_135_tensor_scatter(self):
        ...
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, 152064], 'stride': [152064, 1]}, 'arg1': {'data_type': 'int', 'value': 1}, 'arg2': {'data_type': 'torch.int64', 'shape': [1, mm], 'stride': [mm, 1]}, 'arg3': {'data_type': 'torch.float32', 'shape': [1, mm], 'stride': [mm, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_157_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.int64', 'shape': [1, mm + 1], 'stride': [mm + 1, 1]}, 'key': {'data_type': 'tuple', 'value': ['slice(None, None, None)', -1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_158_torch_isin(self):
        func_name = 'torch.isin'
        args_info = {'arg0': {'data_type': 'torch.int64', 'shape': [1], 'stride': [mm + 1]}, 'arg1': {'data_type': 'torch.int64', 'shape': [2], 'stride': [1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_163_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.int64', 'shape': [1, mm + 1], 'stride': [mm + 1, 1]}, 'key': {'data_type': 'tuple', 'value': ['slice(None, None, None)', 'slice(-1, None, None)']}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_164_tensor_clone(self):
        func_name = 'Tensor.clone'
        args_info = {'arg0': {'data_type': 'torch.int64', 'shape': [1, 1], 'stride': [mm + 1, 1]}, 'memory_format': {'data_type': 'memory_format', 'value': 'torch.contiguous_format'}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_165_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.int64', 'shape': [1, mm + 1], 'stride': [mm + 1, 1]}, 'key': {'data_type': 'tuple', 'value': ['Ellipsis', 'slice(-1, None, None)']}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_166_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.int64', 'shape': [mm + 1], 'stride': [1]}, 'key': {'data_type': 'tuple', 'value': ['Ellipsis', 'slice(-1, None, None)']}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_170_tensor_all(self):
        func_name = 'Tensor.all'
        args_info = {'arg0': {'data_type': 'torch.bool', 'shape': [1, mm + 1], 'stride': [mm + 1, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_205_torch_cat(self):
        func_name = 'torch.cat'
        args_info = {'arg0': {'data_type': 'list', 'value': [{'data_type': 'torch.bfloat16', 'shape': [1, 8, mm, 128], 'stride': [mm * 1024, mm * 128, 128, 1]}, {'data_type': 'torch.bfloat16', 'shape': [1, 8, 1, 128], 'stride': [1024, 128, 128, 1]}]}, 'dim': {'data_type': 'int', 'value': -2}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_206_torch_cat(self):
        func_name = 'torch.cat'
        args_info = {'arg0': {'data_type': 'list', 'value': [{'data_type': 'torch.bfloat16', 'shape': [1, 8, mm, 128], 'stride': [mm * 1024, mm * 128, 128, 1]}, {'data_type': 'torch.bfloat16', 'shape': [1, 8, 1, 128], 'stride': [1024, 128, 1024, 1]}]}, 'dim': {'data_type': 'int', 'value': -2}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_207_torch_nn_functional_scaled_dot_product_attention(self):
        func_name = 'torch.nn.functional.scaled_dot_product_attention'
        args_info = {'arg0': {'data_type': 'torch.bfloat16', 'shape': [1, 40, 1, 128], 'stride': [5120, 128, 128, 1]}, 'arg1': {'data_type': 'torch.bfloat16', 'shape': [1, 8, mm + 1, 128], 'stride': [(mm + 1) * 1024, (mm + 1) * 128, 128, 1]}, 'arg2': {'data_type': 'torch.bfloat16', 'shape': [1, 8, mm + 1, 128], 'stride': [(mm + 1) * 1024, (mm + 1) * 128, 128, 1]}, 'attn_mask': {'data_type': 'NoneType', 'value': None}, 'dropout_p': {'data_type': 'float', 'value': 0.0}, 'scale': {'data_type': 'float', 'value': 0.08838834764831845}, 'is_causal': {'data_type': 'bool', 'value': False}, 'enable_gqa': {'data_type': 'bool', 'value': True}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_220_tensor_add(self):
        func_name = 'Tensor.__add__'
        args_info = {'arg0': {'data_type': 'torch.int64', 'shape': [1, 1], 'stride': [1, 1]}, 'arg1': {'data_type': 'torch.int64', 'shape': [1, 1], 'stride': [mm + 1, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_221_torch_cat(self):
        func_name = 'torch.cat'
        args_info = {'arg0': {'data_type': 'list', 'value': [{'data_type': 'torch.int64', 'shape': [1, mm + 1], 'stride': [mm + 1, 1]}, {'data_type': 'torch.int64', 'shape': [1, 1], 'stride': [1, 1]}]}, 'dim': {'data_type': 'int', 'value': -1}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_222_tensor_new_ones(self):
        func_name = 'Tensor.new_ones'
        args_info = {'arg0': {'data_type': 'torch.int64', 'shape': [1, mm + 1], 'stride': [mm + 1, 1]}, 'arg1': {'data_type': 'tuple', 'value': [1, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_223_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.int64', 'shape': [mm + 1], 'stride': [1]}, 'key': {'data_type': 'int', 'value': -1}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_224_torch_cat(self):
        func_name = 'torch.cat'
        args_info = {'arg0': {'data_type': 'tuple', 'value': [{'data_type': 'torch.int64', 'shape': [mm + 1], 'stride': [1]}, {'data_type': 'torch.int64', 'shape': [1], 'stride': [1]}]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_225_torch_gather(self):
        func_name = 'torch.gather'
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, 152064], 'stride': [152064, 1]}, 'arg1': {'data_type': 'int', 'value': 1}, 'arg2': {'data_type': 'torch.int64', 'shape': [1, mm + 1], 'stride': [mm + 1, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_226_tensor_lt(self):
        func_name = 'Tensor.__lt__'
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, mm + 1], 'stride': [mm + 1, 1]}, 'arg1': {'data_type': 'int', 'value': 0}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_227_tensor_mul(self):
        func_name = 'Tensor.__mul__'
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, mm + 1], 'stride': [mm + 1, 1]}, 'arg1': {'data_type': 'float', 'value': 1.05}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_229_torch_where(self):
        func_name = 'torch.where'
        args_info = {'arg0': {'data_type': 'torch.bool', 'shape': [1, mm + 1], 'stride': [mm + 1, 1]}, 'arg1': {'data_type': 'torch.float32', 'shape': [1, mm + 1], 'stride': [mm + 1, 1]}, 'arg2': {'data_type': 'torch.float32', 'shape': [1, mm + 1], 'stride': [mm + 1, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_230_tensor_scatter(self):
        func_name = 'Tensor.scatter'
        args_info = {'arg0': {'data_type': 'torch.float32', 'shape': [1, 152064], 'stride': [152064, 1]}, 'arg1': {'data_type': 'int', 'value': 1}, 'arg2': {'data_type': 'torch.int64', 'shape': [1, mm + 1], 'stride': [mm + 1, 1]}, 'arg3': {'data_type': 'torch.float32', 'shape': [1, mm + 1], 'stride': [mm + 1, 1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_232_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.int64', 'shape': [1, 7], 'stride': [7, 1]}, 'key': {'data_type': 'tuple', 'value': ['slice(None, None, None)', -1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_233_torch_isin(self):
        func_name = 'torch.isin'
        args_info = {'arg0': {'data_type': 'torch.int64', 'shape': [1], 'stride': [7]}, 'arg1': {'data_type': 'torch.int64', 'shape': [2], 'stride': [1]}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
    ...
    def test_auto_234_tensor_getitem(self):
        func_name = 'Tensor.__getitem__'
        args_info = {'self': {'data_type': 'torch.int64', 'shape': [1, 7], 'stride': [7, 1]}, 'key': {'data_type': 'int', 'value': 0}}
        fn = self._resolve_callable(func_name)
        self.assertIsNotNone(fn, f"callable not found: {func_name}")
        print(f"Testing {func_name} args_info:", args_info) if DEBUG else None
